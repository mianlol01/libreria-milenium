...
<title>${categoria.nombre_categoria}</title>
</head>
<link
...
<body>
	...
	<div class="container-sm main-container">
		<div class="container-fluid text-center">
			<h1 class="main-titulo fs-1">LIBROS DE LA CATEGORIA: ${categoria.nombreCategoria()}</h1>
		</div>
		<div class="container-fluid main-grid">
			<div class="container mt-5">
				<ul class="article-grid">
					<!-- Puedes agregar más artículos aquí -->
					<c:forEach items="${listaLibrosPorCategoria}" var="libro">
						<!-- Puedes agregar más artículos aquí -->
